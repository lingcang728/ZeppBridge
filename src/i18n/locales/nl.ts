...
export default {
  modules: {
    ...
    'components/orbit/OrbitCanvas': {
      canvasLabel: (center: string) => `Taakgrafiek: ${center}`,
      canvasHint:
        'Tab naar een knoop; Enter opent; Spatie of J schakelt lidmaatschap; Delete verwijdert; Links/Rechts beweegt focus langs de ring; +/- zoomt; 0 herstelt de weergave; Ctrl+Z maakt ongedaan',
      stateMember: 'toegevoegd',
      stateCandidate: 'kandidaat',
      stateDisabled: 'niet beschikbaar',
      nodeAria: (label: string, state: string, count: number | null) =>
        count === null
          ? `${label}, ${state}`
          : `${label}, ${state}, ${plural(count, { one: `${count} item`, other: `${count} items` })}`,
      zoomIn: 'Inzoomen',
      zoomOut: 'Uitzoomen',
...
Als je iets van me nodig hebt (welke client ik gebruik, waar het bestand staat), vraag het gewoon.`,
    ...
    'views/AiComposer': {
      ...
      newTask: 'Nieuwe taak',
      taskTitle: 'Taaknaam',
      taskTitlePlaceholder: 'Geef deze analyse een naam',
      workoutsTitle: 'Gekoppelde trainingen',
      workoutsEmpty: 'Nog geen trainingen op deze machine',
      templateTitle: 'Sjabloon',
      noTemplate: 'Geen sjabloon',
      categoriesTitle: 'Analyse-inhoud',
      categoriesEmpty: 'Sleep categorieën erin of klik ze aan om ze mee te nemen',
      promptTitle: 'Je vraag',
      promptPlaceholder:
        'Wat moet de AI analyseren? Bijv. was deze herstelrun de juiste intensiteit?',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      attachTitle: 'Originele bijlagen',
      attachAdd: 'Bestanden toevoegen',
      attachPickerTitle: 'Kies originele bestanden om te refereren',
      attachFilterName: 'PDF en afbeeldingen',
      attachSkipped: (count: number) =>
        `${count} bestand(en) overgeslagen — niet-ondersteund type`,
      attachPickFailed: 'De bestanden konden niet worden toegevoegd',
      attachEmpty:
        'Nog geen bijlagen. Originalen worden ongewijzigd gerefereerd — nooit gekopieerd of geanonimiseerd.',
      optionsTitle: 'Opties',
      preciseGps: 'Precieze route (GPS-coördinaten)',
      preciseGpsHint:
        'Standaard uit. Aan houden geëxporteerde tracks ruwe coördinaten.',
      detailLevel: 'Detailniveau',
      detailSummary: 'Samenvatting',
      detailStandard: 'Standaard',
      detailDetailed: 'Gedetailleerd (inclusief reeksen per punt)',
      mcpShared: 'Delen met taakgebonden MCP',
      mcpSharedHint: 'De lokale MCP-tool mag alleen bevragen wat deze taak dekt.',
      saveTask: 'Taak opslaan',
      savedOk: 'Opgeslagen',
      previewHandoff: 'Overdracht previewen',
      undoAction: 'Ongedaan maken',
      resetView: 'Weergave herstellen',
      zoomIn: 'Inzoomen',
      zoomOut: 'Uitzoomen',
      cardFallback: 'Categorielijst (terugval)',
      cardJoin: 'Toevoegen',
      cardLeave: 'Verwijderen',
      daysBefore: 'Dagen ervoor',
      daysOption: (days: number) => `${days} dagen`,
      includeWorkoutDay: 'Trainingsdag meenemen',
      windowPreview: 'Venster per training',
      noteEditor: 'Persoonlijke notitie',
      notePlaceholder:
        'Context voor de AI: blessurehistorie, doelen, recente vorm. Wordt met de gegevens meegeleverd.',
      attachPanelHint: 'Originele bijlagen toevoegen of verwijderen.',
      panelClose: 'Sluiten',
      desktopOnly: 'Verbind de desktop-backend om op te slaan en te previewen',
      removeAttachment: 'Verwijderen',
      generalWindow: 'Gedeeld venster',
      eachWorkoutWindow: 'Terugblik per training',
    },
    'views/AiHandoffPreview': {
      pageTitle: 'Overdrachtspreview',
      backToCompose: 'Terug naar bewerken',
      refreshPreview: 'Preview vernieuwen',
      coverageTitle: 'Gegevensdekking',
      coverageEmpty: 'De huidige selectie dekt geen categorieën',
      ...
      colUnits: 'Eenheden',
      colState: 'Status',
      coverageCount: (withData: number, inRange: number) =>
        `${withData}/${inRange} dagen`,
      stateMissing: 'Ontbreekt',
      stateOk: 'Heeft gegevens',
      globalWindow: 'Alle records',
      attachTitle: 'Originele bijlagen',
      attachMissingTitle: 'Bijlagen vragen aandacht',
      attachMissingBody:
        'Deze originalen kunnen niet meer worden gevonden. Kies het bestand opnieuw of verwijder de verwijzing — de overdracht gaat niet stilletjes door.',
      attachChangedBody:
        'Deze originalen hebben nu een andere grootte. Bevestig dat het nog hetzelfde bestand is, of kies het opnieuw.',
      attachReselect: 'Opnieuw kiezen',
      attachRemove: 'Verwijderen',
      attachPickerTitle: 'Kies het originele bestand opnieuw',
      attachFilterName: 'PDF en afbeeldingen',
      attachStatusOk: 'Klaar',
      attachStatusMissing: 'Niet gevonden',
      attachStatusChanged: 'Gewijzigd',
      attachManualNote:
        'Deze bestanden worden nooit geüpload. Voeg ze, zodra ze zijn voorbereid, zelf aan het AI-gesprek toe.',
      gpsTitle: 'Precieze route',
      gpsOff: 'GPS-coördinaten uitgesloten (standaard)',
      gpsOn: 'Ruwe GPS-coördinaten worden meegeleverd',
      promptTitle: 'Prompt',
      promptHint:
        'Je kunt hem hier nog bewerken — dit is precies wat er wordt gekopieerd.',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      providerTitle: 'Leveren aan',
      stepsTitle: 'Overdrachtsstappen',
      stepPrepare: 'Bestanden voorbereiden',
      stepCopy: 'Prompt kopiëren',
      stepAttach: 'Bijlagen handmatig toevoegen',
      stepIdle: 'Niet begonnen',
      stepDoing: 'Bezig',
      stepDone: 'Klaar',
      stepFailed: 'Mislukt',
      stepBlocked: 'Geblokkeerd',
      stepWaiting: 'Wacht op jou',
      retry: 'Opnieuw proberen',
      attachConfirm: 'Ik heb de bijlagen in het AI-gesprek toegevoegd',
      attachConfirmDone: 'Toevoegen bevestigd',
      openOutcomeOpened: (label: string) =>
        `${label} is in je browser geopend — er is niets verstuurd`,
      openOutcomeSkipped:
        'Een webpreview kan geen browser voor je openen; bestanden en prompt liggen klaar',
      openOutcomeFailed: 'De browser ging niet open — je kunt het opnieuw proberen',
      outputTitle: 'Gegenereerde bestanden',
      outputDir: 'Uitvoermap',
      outputSize: 'Grootte',
      ctaMain: (label: string) => `Bestanden voorbereiden en ${label} openen`,
      ctaExportOnly: 'Alleen bestanden exporteren',
      ctaHonestNote:
        'De site openen is nog geen versturen: de bestanden blijven op je machine; jij beslist op de AI-pagina wat je overdraagt.',
      staleNotice:
        'Het ontwerp is na het voorbereiden gewijzigd — de bestanden hieronder zijn verouderd. Bereid opnieuw voor voordat je overdraagt.',
      reprepare: 'Opnieuw voorbereiden',
      previewLoadingText: 'Dekking wordt gemeten…',
      previewFailedTitle: 'De preview kon niet worden opgebouwd',
      desktopOnly: 'Verbind de desktop-backend om overdrachtsbestanden voor te bereiden',
      unsavedNote:
        'Dit is een niet-opgeslagen ontwerp — de preview werkt toch; sla het op om het in de takenlijst te bewaren.',
      taskUntitled: 'Taak zonder naam',
      estimatedSize: 'Geschatte exportgrootte',
    },
    'views/BodyStatus': {
      backToOverview: 'Terug naar overzicht',
    ...
    'views/OrbitLab': {
      title: 'Orbit-lab',
      intro:
        'Acceptatiepagina met synthetische gegevens voor de orbit-grafiek: erin slepen voegt toe, voorbij de buitenring eruit slepen verwijdert, wiel zoomt, toetsenbord, verminderde beweging.',
      centerLabel: 'Analysetaak',
      centerSub: 'synthetische gegevens',
      modeGraph: 'Grafiek',
      modeList: 'Lijst',
      addNode: 'Kandidaat-knoop toevoegen',
      removeSelected: 'Selectie verwijderen',
      undoN: (n: number) => `Ongedaan maken (${n})`,
      motionLabel: 'Beweging',
      motionSystem: 'Systeem',
      motionReduced: 'Verminderd',
      motionFull: 'Volledig',
      frameMs: (last: string, avg: string, max: string) =>
        `Sim-frame: laatste ${last} ms · gem. over 60 frames ${avg} ms · max ${max} ms`,
      simSettled: 'Lay-out gestabiliseerd',
      simRunning: 'Stabiliseren…',
      focusedNone: 'Focus: geen',
      focusedNode: (label: string) => `Focus: ${label}`,
      lastEvent: (text: string) => `Laatste gebeurtenis: ${text}`,
      noEvent: 'Nog geen gebeurtenissen',
      inspectorTitle: 'Geselecteerde knoop',
      inspectorEmpty: 'Klik of druk op Enter op een knoop om hem te inspecteren.',
      stateLabel: 'Lidmaatschap',
      stateMember: 'Lid',
      stateCandidate: 'Kandidaat',
      stateDisabled: 'Uitgeschakeld',
      slotLabel: 'orbitSlot-override (leeg = auto)',
      open: 'Openen',
      join: 'Aansluiten',
      leave: 'Verlaten',
      remove: 'Verwijderen',
      listTitle: 'Kaartlijst (terugvalingang)',
      listIntro:
        'Elke actie werkt zonder de grafiek: aansluiten, verlaten, openen en verwijderen.',
      listEmpty: 'Geen knopen.',
      categories: {
        workout: 'Training',
        sleep: 'Slaap',
        recovery: 'Herstel',
        ...
        body: 'Lichaam',
        personal_note: 'Notities',
        attachment: 'Bijlage',
      },
      subDays: (n: number) => `afgelopen ${n} dagen`,
      subItems: (n: number) =>
        plural(n, { one: `${n} item`, other: `${n} items` }),
      subNone: 'geen gegevens',
    },
    'views/Overview': {
