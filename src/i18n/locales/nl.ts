...
export default {
  modules: {
    App: {
      ...
      accountPrefix: 'Ingelogd als: ',
      manage: 'Beheren',
      privacyLink: 'Beveiligings- en privacy-instellingen',
      ...
      noAccount: 'Geen account herkend',
...
Als je iets van me nodig hebt (welke client ik gebruik, waar het bestand staat), vraag het gewoon.`,
    ...
    'views/Overview': {
      collapseHero: 'Introductie inklappen',
      collapseOnce: 'Alleen deze keer',
      collapseAlways: 'Niet meer tonen',
      showHero: 'Introductie tonen',
      cancelCollapse: 'Annuleren',
      heroTitleLine1: 'De gegevens van je horloge,',
      heroTitleLine2: 'klaar om door te geven aan een AI',
      valueSecure: 'Veilig',
      valueSecureSub: 'Gegevens blijven op deze machine',
      valuePrivate: 'Privé',
      valuePrivateSub: 'Ruwe records worden nooit geüpload',
      valueAiReady: 'AI-gereed',
      valueAiReadySub: 'Gestructureerd voordat het vertrekt',
      heroVisualAria: 'Gegevens van herkende apparaten stromen naar een cloud-AI',
      aiNodeAria: 'Overdracht aan een cloud-AI: ChatGPT, Doubao, DeepSeek',
