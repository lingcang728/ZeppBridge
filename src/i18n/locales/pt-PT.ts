...
export default {
  modules: {
    ...
    'components/orbit/OrbitCanvas': {
      ...
      canvasHint:
        'Tab vai para um nó; Enter abre; Espaço ou J alterna a inclusão; Delete remove; Esquerda/Direita movem o foco ao longo do anel; +/- faz zoom; 0 repõe a vista; Ctrl+Z anula',
      stateMember: 'adicionado',
    ...
    'views/AiComposer': {
      ...
      taskTitlePlaceholder: 'Dá um nome a esta análise',
      workoutsTitle: 'Treinos ligados',
      workoutsEmpty: 'Ainda não há treinos nesta máquina',
      templateTitle: 'Modelo',
      noTemplate: 'Sem modelo',
      categoriesTitle: 'Conteúdo da análise',
      categoriesEmpty: 'Arrasta para dentro ou clica nas categorias para as incluir',
      promptTitle: 'A tua pergunta',
      promptPlaceholder:
        'O que deve a IA analisar? P.ex.: esta corrida de recuperação teve a intensidade certa?',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      attachTitle: 'Anexos originais',
      attachAdd: 'Adicionar ficheiros',
      attachPickerTitle: 'Escolher ficheiros originais para referenciar',
      attachFilterName: 'PDF e imagens',
      attachSkipped: (count: number) =>
        plural(count, {
          one: `${count} ficheiro saltado — tipo não suportado`,
          other: `${count} ficheiros saltados — tipo não suportado`,
        }),
      attachPickFailed: 'Não foi possível adicionar os ficheiros',
      attachEmpty:
        'Ainda sem anexos. Os originais são referenciados tal como estão — nunca copiados nem desidentificados.',
      optionsTitle: 'Opções',
      preciseGps: 'Percurso preciso (coordenadas GPS)',
      preciseGpsHint:
        'Desligado por predefinição. Ligado, os percursos exportados mantêm as coordenadas em bruto.',
      detailLevel: 'Nível de detalhe',
      detailSummary: 'Resumo',
      detailStandard: 'Padrão',
      detailDetailed: 'Detalhado (inclui séries ponto a ponto)',
      mcpShared: 'Partilhar com o MCP de âmbito de tarefa',
      mcpSharedHint: 'A ferramenta MCP local só pode consultar o que esta tarefa cobre.',
      saveTask: 'Guardar tarefa',
      savedOk: 'Guardado',
      previewHandoff: 'Pré-visualizar a entrega',
      undoAction: 'Anular',
      resetView: 'Repor a vista',
      zoomIn: 'Aumentar zoom',
      zoomOut: 'Reduzir zoom',
      cardFallback: 'Lista de categorias (alternativa)',
      cardJoin: 'Adicionar',
      cardLeave: 'Remover',
      ...
      notePlaceholder:
        'Contexto para a IA: histórico de lesões, objetivos, forma recente. Vai com os dados.',
      attachPanelHint: 'Adiciona ou remove anexos originais.',
      panelClose: 'Fechar',
      desktopOnly: 'Liga o backend de desktop para guardar e pré-visualizar',
      removeAttachment: 'Remover',
      generalWindow: 'Janela partilhada',
      eachWorkoutWindow: 'Retrospetiva por treino',
    },
    'views/AiHandoffPreview': {
      pageTitle: 'Pré-visualização da entrega',
      backToCompose: 'Voltar à edição',
      refreshPreview: 'Atualizar a pré-visualização',
      coverageTitle: 'Cobertura de dados',
      coverageEmpty: 'A seleção atual não cobre nenhuma categoria',
      ...
      stateOk: 'Com dados',
      globalWindow: 'Todos os registos',
      attachTitle: 'Anexos originais',
      attachMissingTitle: 'Os anexos precisam de atenção',
      attachMissingBody:
        'Estes originais já não se encontram. Volta a selecionar o ficheiro ou remove a referência — a entrega não avança em silêncio.',
      attachChangedBody:
        'Estes originais têm agora um tamanho diferente. Confirma que ainda é o mesmo ficheiro, ou volta a selecioná-lo.',
      attachReselect: 'Voltar a selecionar',
      attachRemove: 'Remover',
      attachPickerTitle: 'Voltar a selecionar o ficheiro original',
      attachFilterName: 'PDF e imagens',
      attachStatusOk: 'Pronto',
      attachStatusMissing: 'Não encontrado',
      attachStatusChanged: 'Alterado',
      attachManualNote:
        'Estes ficheiros nunca são enviados. Depois de preparados, és tu que os juntas à conversa de IA.',
      gpsTitle: 'Percurso preciso',
      gpsOff: 'Coordenadas GPS excluídas (predefinição)',
      gpsOn: 'As coordenadas GPS em bruto serão incluídas',
      promptTitle: 'Prompt',
      promptHint: 'Ainda o podes editar aqui — é exatamente isto que é copiado.',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      providerTitle: 'Entregar a',
      stepsTitle: 'Passos da entrega',
      stepPrepare: 'Preparar ficheiros',
      stepCopy: 'Copiar o prompt',
      stepAttach: 'Juntar os anexos à mão',
      stepIdle: 'Por começar',
      stepDoing: 'A trabalhar',
      stepDone: 'Feito',
      stepFailed: 'Falhou',
      stepBlocked: 'Bloqueado',
      stepWaiting: 'À espera de ti',
      retry: 'Tentar novamente',
      attachConfirm: 'Juntei os anexos na conversa de IA',
      attachConfirmDone: 'Confirmado: anexos juntados',
      openOutcomeOpened: (label: string) => `${label} aberto no teu browser — nada foi enviado`,
      openOutcomeSkipped:
        'Uma pré-visualização web não consegue abrir um browser por ti; os ficheiros e o prompt estão prontos',
      openOutcomeFailed: 'O browser não abriu — podes tentar novamente',
      outputTitle: 'Ficheiros gerados',
      outputDir: 'Pasta de saída',
      outputSize: 'Tamanho',
      ctaMain: (label: string) => `Preparar ficheiros e abrir ${label}`,
      ctaExportOnly: 'Só exportar ficheiros',
      ctaHonestNote:
        'Abrir o site não é enviar: os ficheiros ficam na tua máquina; decides na página da IA o que entregar.',
      staleNotice:
        'O rascunho mudou depois da preparação — os ficheiros listados abaixo estão desatualizados. Prepara outra vez antes de entregar.',
      reprepare: 'Preparar outra vez',
      previewLoadingText: 'A medir a cobertura…',
      previewFailedTitle: 'Não foi possível construir a pré-visualização',
      desktopOnly: 'Liga o backend de desktop para preparar os ficheiros de entrega',
      unsavedNote:
        'Isto é um rascunho não guardado — a pré-visualização funciona na mesma; guarda-o para o manter na lista de tarefas.',
    ...
    'views/OrbitLab': {
      ...
      intro:
        'Página de aceitação com dados sintéticos para o grafo de órbita: arrasta para dentro para adicionar, para fora além do anel exterior para remover, zoom com a roda, teclado, movimento reduzido.',
      ...
      undoN: (n: number) => `Anular (${n})`,
      motionLabel: 'Movimento',
      motionSystem: 'Sistema',
      motionReduced: 'Reduzido',
      motionFull: 'Completo',
      frameMs: (last: string, avg: string, max: string) =>
        `Frame da simulação: último ${last} ms · média de 60 frames ${avg} ms · máx ${max} ms`,
      simSettled: 'Disposição estabilizada',
      simRunning: 'A estabilizar…',
      focusedNone: 'Foco: nenhum',
      focusedNode: (label: string) => `Foco: ${label}`,
      lastEvent: (text: string) => `Último evento: ${text}`,
      noEvent: 'Ainda sem eventos',
      inspectorTitle: 'Nó selecionado',
      inspectorEmpty: 'Clica ou prime Enter num nó para o inspecionar.',
      stateLabel: 'Inclusão',
      stateMember: 'Membro',
      stateCandidate: 'Candidato',
      stateDisabled: 'Desativado',
      slotLabel: 'override de orbitSlot (vazio = automático)',
      open: 'Abrir',
      join: 'Juntar',
      leave: 'Sair',
      remove: 'Remover',
      listTitle: 'Lista de cartões (entrada alternativa)',
      listIntro: 'Todas as ações funcionam sem o grafo: juntar, sair, abrir e remover.',
      listEmpty: 'Sem nós.',
      categories: {
        workout: 'Treino',
        sleep: 'Sono',
      ...
      subItems: (n: number) =>
        plural(n, { one: `${n} item`, other: `${n} itens` }),
      subNone: 'sem dados',
    },
    'views/Overview': {
