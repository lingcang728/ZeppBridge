...
export default {
  modules: {
    ...
    App: {
      ...
      accountPrefix: 'Conta: ',
      manage: 'Gerir',
      privacyLink: 'Definições de segurança e privacidade',
