...
Wenn du etwas von mir brauchst (welchen Client ich nutze, wo die Datei liegt), frag einfach.`,
    ...
    'components/orbit/OrbitCanvas': {
      canvasHint:
        'Tab zum Knoten; Enter öffnet; Leertaste oder J schaltet Mitgliedschaft; Entf entfernt; Links/Rechts bewegen den Fokus entlang des Rings; +/− zoomen; 0 setzt die Ansicht zurück; Strg+Z macht rückgängig',
      canvasLabel: (center: string) => `Aufgabengraph: ${center}`,
      nodeAria: (label: string, state: string, count: number | null) =>
        count === null ? `${label}, ${state}` : `${label}, ${state}, ${count} Einträge`,
      resetView: 'Ansicht zurücksetzen',
      stateCandidate: 'Kandidat',
      stateDisabled: 'nicht verfügbar',
      stateMember: 'hinzugefügt',
      zoomIn: 'Vergrößern',
      zoomOut: 'Verkleinern',
    },
    ...
    'views/AiComposer': {
      ...
      attachFilterName: 'PDF und Bilder',
      attachPanelHint: 'Original-Anhänge hinzufügen oder entfernen.',
      attachPickFailed: 'Die Dateien konnten nicht hinzugefügt werden',
      attachPickerTitle: 'Originaldateien zum Referenzieren wählen',
      attachSkipped: (count: number) =>
        plural(count, {
          one: `${count} Datei übersprungen – Typ nicht unterstützt`,
          other: `${count} Dateien übersprungen – Typ nicht unterstützt`,
        }),
      attachTitle: 'Original-Anhänge',
      cardFallback: 'Kategorieliste (Fallback)',
      cardJoin: 'Hinzufügen',
      cardLeave: 'Entfernen',
      categoriesEmpty: 'Ziehe Kategorien hinein oder klicke sie an, um sie einzuschließen',
      categoriesTitle: 'Analyseinhalt',
      ...
      desktopOnly: 'Verbinde das Desktop-Backend, um zu speichern und eine Vorschau zu sehen',
      detailDetailed: 'Detailliert (inkl. Messpunkt-Serien)',
      detailLevel: 'Detailgrad',
      detailStandard: 'Standard',
      detailSummary: 'Zusammenfassung',
      eachWorkoutWindow: 'Rückblick pro Training',
      generalWindow: 'Gemeinsames Zeitfenster',
      includeWorkoutDay: 'Trainingstag einschließen',
      mcpShared: 'Für aufgabenbezogenes MCP freigeben',
      mcpSharedHint: 'Das lokale MCP-Werkzeug darf nur abfragen, was diese Aufgabe abdeckt.',
      newTask: 'Neue Aufgabe',
      noTemplate: 'Keine Vorlage',
      noteEditor: 'Persönliche Notiz',
      notePlaceholder:
        'Kontext für die KI: Verletzungen, Ziele, aktuelle Form. Wird mit den Daten mitgeliefert.',
      optionsTitle: 'Optionen',
      pageIntro:
        'Stelle aus lokalen Gesundheitsdaten eine Analyseaufgabe zusammen und übermittle sie selbst an eine KI.',
      pageTitle: 'An KI übergeben',
      panelClose: 'Schließen',
      preciseGps: 'Genaue Route (GPS-Koordinaten)',
      preciseGpsHint:
        'Standardmäßig aus. Wenn an, behalten exportierte Tracks die rohen Koordinaten.',
      previewHandoff: 'Übergabe-Vorschau',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      promptPlaceholder:
        'Was soll die KI analysieren? Z. B.: War der Erholungslauf in der richtigen Intensität?',
      promptTitle: 'Deine Frage',
      ...
      taskTitlePlaceholder: 'Gib dieser Analyse einen Namen',
      templateTitle: 'Vorlage',
      undoAction: 'Rückgängig',
      windowPreview: 'Zeitfenster pro Training',
      workoutsEmpty: 'Noch keine Trainings auf diesem Rechner',
      workoutsTitle: 'Verknüpfte Trainings',
      zoomIn: 'Vergrößern',
      zoomOut: 'Verkleinern',
    },
    'views/AiHandoffPreview': {
      attachChangedBody:
        'Diese Originale haben jetzt eine andere Größe. Bestätige, dass es noch dieselbe Datei ist, oder wähle sie neu.',
      attachConfirm: 'Ich habe die Anhänge im KI-Dialog hinzugefügt',
      attachConfirmDone: 'Hinzufügen bestätigt',
      attachFilterName: 'PDF und Bilder',
      attachManualNote:
        'Diese Dateien werden nie hochgeladen. Füge sie selbst zum KI-Dialog hinzu, sobald sie bereit sind.',
      attachMissingBody:
        'Diese Originale werden nicht mehr gefunden. Wähle die Datei neu oder entferne die Referenz – die Übergabe geht nicht still weiter.',
      attachMissingTitle: 'Anhänge brauchen Aufmerksamkeit',
      attachPickerTitle: 'Originaldatei neu wählen',
      attachRemove: 'Entfernen',
      attachReselect: 'Neu wählen',
      attachStatusChanged: 'Geändert',
      attachStatusMissing: 'Nicht gefunden',
      attachStatusOk: 'Bereit',
      attachTitle: 'Original-Anhänge',
      backToCompose: 'Zurück zum Bearbeiten',
      ...
      colWorkout: 'Training',
      coverageCount: (withData: number, inRange: number) => `${withData}/${inRange} Tage`,
      coverageEmpty: 'Die aktuelle Auswahl deckt keine Kategorien ab',
      coverageTitle: 'Datenabdeckung',
      ctaExportOnly: 'Nur Dateien exportieren',
      ctaHonestNote:
        'Die Seite zu öffnen ist noch kein Senden: Die Dateien bleiben auf deinem Rechner; was du übergibst, entscheidest du auf der KI-Seite.',
      ctaMain: (label: string) => `Dateien vorbereiten und ${label} öffnen`,
      desktopOnly: 'Verbinde das Desktop-Backend, um Übergabedateien vorzubereiten',
      estimatedSize: 'Geschätzte Exportgröße',
      globalWindow: 'Alle Einträge',
      gpsOff: 'GPS-Koordinaten ausgenommen (Standard)',
      gpsOn: 'Rohe GPS-Koordinaten werden enthalten sein',
      gpsTitle: 'Genaue Route',
      openOutcomeFailed: 'Der Browser hat nicht geöffnet – du kannst es erneut versuchen',
      openOutcomeOpened: (label: string) =>
        `${label} in deinem Browser geöffnet – nichts wurde gesendet`,
      openOutcomeSkipped:
        'Eine Web-Vorschau kann den Browser nicht für dich öffnen; Dateien und Prompt sind bereit',
      outputDir: 'Ausgabeordner',
      outputSize: 'Größe',
      outputTitle: 'Erzeugte Dateien',
      pageTitle: 'Übergabe-Vorschau',
      previewFailedTitle: 'Die Vorschau konnte nicht erstellt werden',
      previewLoadingText: 'Abdeckung wird vermessen…',
      promptCounter: (used: number, max: number) => `${used}/${max}`,
      promptHint:
        'Du kannst hier noch letzte Änderungen machen – genau das wird kopiert.',
      promptTitle: 'Prompt',
      providerTitle: 'Übergeben an',
      refreshPreview: 'Vorschau aktualisieren',
      reprepare: 'Erneut vorbereiten',
      retry: 'Erneut versuchen',
      staleNotice:
        'Der Entwurf wurde nach der Vorbereitung geändert – die unten aufgeführten Dateien sind veraltet. Vor der Übergabe erneut vorbereiten.',
      stateMissing: 'Fehlt',
      stateOk: 'Hat Daten',
      stepAttach: 'Anhänge von Hand hinzufügen',
      stepBlocked: 'Blockiert',
      stepCopy: 'Prompt kopieren',
      stepDoing: 'Läuft',
      stepDone: 'Fertig',
      stepFailed: 'Fehlgeschlagen',
      stepIdle: 'Nicht gestartet',
      stepPrepare: 'Dateien vorbereiten',
      stepWaiting: 'Wartet auf dich',
      stepsTitle: 'Übergabeschritte',
      taskUntitled: 'Unbenannte Aufgabe',
      unsavedNote:
        'Dies ist ein ungespeicherter Entwurf – die Vorschau funktioniert trotzdem; speichere sie, um sie in der Aufgabenliste zu behalten.',
    },
    'views/BodyStatus': {
      backToOverview: 'Zurück zur Übersicht',
    ...
    'views/OrbitLab': {
      addNode: 'Kandidaten-Knoten hinzufügen',
      categories: {
        attachment: 'Anhang',
        body: 'Körper',
        heart_rate: 'Herzfrequenz',
        personal_note: 'Notizen',
        recovery: 'Erholung',
        sleep: 'Schlaf',
        training: 'Trainingsbelastung',
        workout: 'Training',
      },
      centerLabel: 'Analyseaufgabe',
      centerSub: 'synthetische Daten',
      focusedNode: (label: string) => `Fokus: ${label}`,
      focusedNone: 'Fokus: keiner',
      frameMs: (last: string, avg: string, max: string) =>
        `Sim-Frame: zuletzt ${last} ms · 60-Frame-Ø ${avg} ms · max ${max} ms`,
      inspectorEmpty: 'Klicke einen Knoten an oder drücke Enter, um ihn zu untersuchen.',
      inspectorTitle: 'Gewählter Knoten',
      intro:
        'Abnahmeseite für den Orbit-Graphen mit synthetischen Daten: hineinziehen zum Hinzufügen, über den Außenring hinausziehen zum Entfernen, Rad-Zoom, Tastatur, reduzierte Bewegung.',
      join: 'Hinzufügen',
      lastEvent: (text: string) => `Letztes Ereignis: ${text}`,
      leave: 'Entfernen',
      listEmpty: 'Keine Knoten.',
      listIntro:
        'Alle Aktionen gehen auch ohne den Graphen: hinzufügen, entfernen, öffnen und löschen.',
      listTitle: 'Kartenliste (Ersatzzugang)',
      modeGraph: 'Graph',
      modeList: 'Liste',
      motionFull: 'Voll',
      ...
      motionSystem: 'System',
      noEvent: 'Noch keine Ereignisse',
      open: 'Öffnen',
      remove: 'Entfernen',
      removeSelected: 'Auswahl entfernen',
      simRunning: 'Wird stabilisiert…',
      simSettled: 'Layout stabil',
      slotLabel: 'orbitSlot-Override (leer = automatisch)',
      stateCandidate: 'Kandidat',
      stateDisabled: 'Deaktiviert',
      stateLabel: 'Mitgliedschaft',
      stateMember: 'Mitglied',
      subDays: (n: number) => `letzte ${n} Tage`,
      subItems: (n: number) => `${n} Elemente`,
      subNone: 'keine Daten',
      title: 'Orbit-Labor',
      undoN: (n: number) => `Rückgängig (${n})`,
    },
    'views/Overview': {
      bodyEmpty:
