...
const messages = defineMessages(
  ...
  },
  {
    ...
    title: 'Schlafaufzeichnung',
    loadingDetail: 'Schlafdetails werden geladen…',
    loadFailedTitle: 'Diese Schlafaufzeichnung konnte nicht geladen werden',
    loadFailed: 'Schlafdetails sind gerade nicht verfügbar',
    retry: 'Erneut versuchen',
    notFoundTitle: 'Diese Schlafaufzeichnung wurde nicht gefunden',
    notFoundMessage: 'Sie wurde möglicherweise bereits bereinigt oder ist noch nicht auf diesen Rechner synchronisiert worden.',
    heroAria: 'Schlafdauer und Bewertung',
    durationKicker: 'Schlafdauer',
    heroMeta: (fellAsleep: string, wokeUp: string, inBed: string) =>
      `Eingeschlafen ${fellAsleep} · aufgewacht ${wokeUp} · im Bett ${inBed}`,
    scoreKicker: 'Schlafbewertung',
    scoreNote: 'Vom Gerät ermittelt; wird unverändert angezeigt.',
    stagesAria: 'Schlafphasen',
    stagesTitle: 'Schlafphasen',
    stageHelpButton: 'Was die Phasen bedeuten',
    stageHelp: 'Tiefschlaf: die erholsamste Phase. Leichter Schlaf: die Übergangsphase, die den grössten Teil der Nacht ausmacht. REM-Schlaf: schnelle Augenbewegungen, meist verbunden mit Gedächtnis und Träumen. Wach: nächtliches Aufwachen oder wache Phasen. Das sind Begriffserklärungen, keine medizinische Diagnose.',
    ...
    deviceFirmware: 'Firmware',
    deviceId: 'Geräte-ID',
    footnote: 'Nur die Phasenübersicht, die die Cloud tatsächlich geliefert hat. Fehlt das REM-Feld, steht dort „Nicht angegeben" — nie durch Subtraktion errechnet — und eine nicht gelieferte Zeitleiste wird nie gezeichnet.',
    notProvided: 'Nicht angegeben',
    syncTimeMissing: 'Synchronisierungszeit nicht angegeben',
    lastCloudSync: (clock: string) => `Letzte Cloud-Synchronisierung ${clock}`,
    deviceUndetermined: 'Gerät nicht ermittelt',
    hoursAxis: 'Stunden',
    tooltipTotal: (date: string, hours: string) => `<b>${date} — insgesamt ${hours} Std. geschlafen</b><br/>`,
    tooltipRow: (name: string, hours: number) => `${name}: ${hours} Std.<br/>`,
  },
);
