...
const messages = defineMessages(
  ...
  },
  {
    ...
    eyebrow: 'Tagesaktivität',
    title: 'Tagesaktivität',
    intro: 'Tägliche Trends für Schritte, Distanz, aktive Kalorien und aktive Minuten. Vergleich nur mit deinen eigenen bisherigen Aufzeichnungen; Tage ohne Daten bleiben leer statt mit einer Null aufgefüllt zu werden.',
    rangeAria: 'Zeitraum',
    ...
    loadingAria: 'Tagesaktivität wird geladen',
    noneInRange: 'In diesem Zeitraum keine Aktivitätsdaten. Einen längeren Zeitraum wählen oder zuerst synchronisieren.',
    emptyCard: 'In diesem Zeitraum nichts aufgezeichnet.',
    stepsLabel: 'Schritte',
    stepsHint: 'Tägliche Schrittsumme der Uhr',
    stepsUnit: 'Schritte',
    distanceLabel: 'Distanz',
    distanceHint: 'An diesem Tag zurückgelegte Distanz',
    distanceUnit: 'm',
    caloriesLabel: 'Aktive Kalorien',
    caloriesHint: 'Nur Aktivität, ohne Grundumsatz',
    caloriesUnit: 'kcal',
    minutesLabel: 'Aktive Minuten',
    minutesHint: 'Von der Uhr als aktiv gezählte Minuten',
    minutesUnit: 'Min.',
  },
);
