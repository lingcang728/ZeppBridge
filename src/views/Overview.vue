...
const messages = defineMessages(
  ...
  },
  {
    ...
    valueSecure: 'Sicher',
    valueSecureSub: 'Daten bleiben auf diesem Gerät',
    valuePrivate: 'Privat',
    valuePrivateSub: 'Rohdaten werden nie hochgeladen',
    valueAiReady: 'KI-bereit',
    valueAiReadySub: 'Strukturiert, bevor sie das Gerät verlassen',
    heroVisualAria: 'Daten erkannter Geräte fliessen zu einer Cloud-KI',
    ...
    loadFailedTitle: 'Datenübersicht konnte nicht gelesen werden',
    retry: 'Erneut versuchen',
    healthUnavailable: 'Gesundheitsdaten sind gerade nicht verfügbar',
    partialUnavailable: 'Einige Datenströme wurden noch nicht abgerufen',
    ...
    hrZonesAria: 'Herzfrequenzzonen (absolute Schwellenwerte)',
    hrEmpty: 'Nach einer Synchronisierung erscheint hier der reale Herzfrequenzverlauf.',
    hrMore: 'Volle 24 Stunden',
    hrTooltip: (clock: string, value: number) => `${clock}　<b>${value}</b> Schläge/Min`,
    zoneRest: 'Ruhe 0–99',
    ...
    sleepSub: 'Schlafstruktur auf einen Blick',
    sleepBarAria: 'Anteil der Schlafphasen',
    sleepEmpty: 'Nach einer Synchronisierung erscheint hier der Schlaf der letzten Nacht.',
    bodyPanelAria: 'Körperstatus öffnen',
    bodyTitle: 'Körperstatus',
    factRecovery: 'Erholung',
    factStress: 'Stress',
    factSpo2: 'SpO2',
    bodySparkLabel: 'Erholung der letzten 7 Tage',
    bodyThin: 'Zu wenige Einträge in den letzten 7 Tagen für einen Trend',
    bodyEmpty: 'Erholung, Stress und Blutsauerstoff erscheinen hier nach einer Synchronisierung',
    ...
    trainingThin: 'Zu wenige Einträge in den letzten 7 Tagen für einen Trend',
    trainingEmpty: 'VO₂max und Trainingsbelastung erscheinen hier nach einer Synchronisierung',
    recentAria: 'Letzte Einträge',
    recentTitle: 'Letzte Einträge',
    recentSub: 'Schlaf, Läufe und Krafttraining',
    seeAll: 'Alle anzeigen',
    recentEmpty: 'Noch nichts aufgezeichnet. Nach einer Synchronisierung erscheint hier etwas.',
    sleepRecordTitle: 'Schlaf',
    sleepScore: (score: number) => `Schlafwert ${score}`,
    avgHr: (value: number) => `Ø-Herzfrequenz ${value}`,
