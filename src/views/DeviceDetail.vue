...
const messages = defineMessages(
  ...
  },
  {
    ...
    notFoundMessage: 'Puede que se haya quitado de la cuenta, o que este equipo todavía no lo haya identificado.',
    reidentify: 'Volver a identificar dispositivos',
    factsAria: 'Información del dispositivo',
    factOrigin: 'De dónde salió el modelo',
    factFirmware: 'Firmware',
    factLastData: 'Últimos datos',
    factHasLocal: 'Datos locales',
    factDeviceId: 'ID del dispositivo',
    hasLocalYes: 'Sí',
    hasLocalNo: 'Aún no',
    factsNote: 'El ID del dispositivo se usa solo en este equipo, en pantalla solo se muestran sus últimos cuatro caracteres, y nunca llega a una exportación ni a un reporte de error.',
    assignAria: 'Identificación del modelo',
    assignTitle: '¿Es correcto?',
    assignSub: 'Si la coincidencia está mal (por ejemplo, en realidad es un Balance 2 y aquí dice otra cosa), puedes indicar tú mismo el modelo correcto. Tu elección se queda en este equipo, aparece como «Modelo que elegiste» en vez de pasar por una coincidencia automática, y puedes retirarla cuando quieras.',
    changeModel: 'Elegir otro',
    pickModel: 'Está mal, déjame elegir',
    clearAssignment: 'Retirar la elección y volver a lo automático',
    noLocalIdentifier: 'Este dispositivo no tiene un identificador local, así que no se puede guardar una elección para él.',
    originUnknown: 'Desconocido',
    originUserAssigned: 'Lo elegiste la última vez',
    originExact: 'Coincidencia exacta en el catálogo integrado',
    originAlias: 'Coincidencia por alias en el catálogo integrado',
    originNoMatchCloud: 'Sin coincidencia (la nube no dio un nombre de producto reconocible)',
