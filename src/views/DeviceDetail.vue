...
const messages = defineMessages(
  ...
  },
  {
    ...
    notFoundTitle: 'Dieses Gerät ist nicht vorhanden',
    notFoundMessage: 'Es wurde möglicherweise aus dem Konto entfernt, oder dieser Rechner hat es noch nicht erkannt.',
    reidentify: 'Geräte erneut erkennen',
    factsAria: 'Geräteinformationen',
    factOrigin: 'Herkunft des Modells',
    factFirmware: 'Firmware',
    factLastData: 'Letzte Daten',
    factHasLocal: 'Lokale Daten vorhanden',
    factDeviceId: 'Geräte-ID',
    hasLocalYes: 'Ja',
    hasLocalNo: 'Noch keine',
    factsNote: 'Die Geräte-ID wird nur auf diesem Rechner verwendet, auf dem Bildschirm erscheinen immer nur ihre letzten vier Zeichen, und sie gelangt nie in einen Export oder Fehlerbericht.',
    assignAria: 'Modellzuordnung',
    assignTitle: 'Stimmt das?',
    assignSub: 'Wenn die Zuordnung falsch ist — es handelt sich zum Beispiel wirklich um eine Balance 2, hier steht aber ein anderes Modell —, kannst du das richtige Modell selbst auswählen. Deine Auswahl bleibt auf diesem Rechner, wird als „von dir zugeordnetes Modell" gekennzeichnet statt sich als automatische Erkennung auszugeben, und kann jederzeit zurückgenommen werden.',
    changeModel: 'Anderes auswählen',
    pickModel: 'Das stimmt nicht, ich wähle selbst',
    clearAssignment: 'Auswahl zurücknehmen und automatische Erkennung nutzen',
    noLocalIdentifier: 'Dieses Gerät hat keine lokale Kennung, daher kann keine Auswahl dafür gespeichert werden.',
    originUnknown: 'Unbekannt',
    originUserAssigned: 'Du hast es zuletzt selbst zugeordnet',
    originExact: 'Exakter Treffer im integrierten Gerätekatalog',
    originAlias: 'Alias-Treffer im integrierten Gerätekatalog',
    originNoMatchCloud: 'Kein Treffer (die Cloud hat keinen erkennbaren Produktnamen geliefert)',
    originCatalog: 'Treffer im integrierten Gerätekatalog',
