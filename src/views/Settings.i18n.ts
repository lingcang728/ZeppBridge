...
如果你需要我提供什么信息（比如我用的是哪个客户端、文件放在哪），直接问我。`,
    ...
    verifyFailed: '验证未完成',
    clearAuthConfirm: '确定清除认证信息吗？本地健康数据会保留。',
    authCleared: '认证已清除，本地健康数据仍保留。',
...
If you need anything from me (which client I use, where the file lives), just ask.`,
    ...
    clearAuthConfirm: 'Clear the credentials? Local health data is kept.',
    authCleared: 'Credentials cleared. Local health data is still here.',
