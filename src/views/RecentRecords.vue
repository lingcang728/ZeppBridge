...
const messages = defineMessages(
  ...
  },
  {
    ...
    intro: 'Kürzlich synchronisierte Schlaf- und Trainingseinträge im Vergleich.',
    loadingLabel: 'Letzte Einträge werden geladen',
    loadFailedTitle: 'Letzte Einträge konnten nicht geladen werden',
    retry: 'Erneut versuchen',
    partialUnavailable: 'Einige Daten sind gerade nicht verfügbar',
    filterAll: 'Alle',
    ...
    noWorkoutsOfType: 'Für diesen Trainingstyp gibt es nichts anzuzeigen.',
    hiddenIncomplete: (count: number) => `${count} unvollständige Einträge ausgeblendet`,
