...
const messages = defineMessages(
  ...
  },
  {
    ...
    title: 'Körperstatus',
    intro: 'Lokale Trends für Erholung, Stress, Blutsauerstoff, HRV, Atemfrequenz und Ruheherzfrequenz. Alles aus synchronisierten Aufzeichnungen gelesen, nichts hochgerechnet.',
    rangeAria: 'Zeitraum',
    ...
    noneInRange: 'Keine Körperstatus-Aufzeichnungen in diesem Zeitraum. Einen längeren Zeitraum wählen oder zuerst synchronisieren.',
    emptyCard: 'Nichts aufgezeichnet in diesem Zeitraum.',
    readinessLabel: 'Erholungsstatus',
    readinessHint: 'Die Uhr gewichtet Schlaf, HRV und Ruheherzfrequenz zu einem Wert',
    stressLabel: 'Stress',
    stressHint: 'Tagesdurchschnitt; das schattierte Band zeigt die an diesem Tag gemessene Spanne',
    curveCardAria: '24-Stunden-Stress',
    curveTitle: 'Letzte 24 Stunden',
    curveSub: 'Die Uhr misst alle fünf Minuten; einzelne Messwerte in zeitlicher Reihenfolge',
    curveChartAria: 'Stressverlauf der letzten 24 Stunden',
    curveNoSamples: 'Keine Stresswerte in den letzten 24 Stunden, daher gibt es hier keine Kurve zu zeichnen. So sieht es aus, wenn die Uhr nicht getragen wurde oder die Ganztagesüberwachung ausgeschaltet ist.',
    curveNote: 'Die Bereiche (entspannt 1–39, normal 40–59, mittel 60–79, hoch 80–100) stammen von Zepp selbst, nicht von uns. Zeiten ohne Messwerte bleiben leer statt mit Nullen aufgefüllt.',
    statLatest: 'Aktuell',
    ...
    spo2Hint: 'Einzelne SpO2-Messwerte pro Tag gemittelt; das Band zeigt die an diesem Tag gemessene Spanne',
    spo2Empty: 'Keine einzelnen SpO2-Messwerte in diesem Zeitraum.',
    odiLabel: 'Nächtlicher SpO2-ODI',
    odiHint: 'Sauerstoffabfälle pro Stunde; niedriger ist besser',
    hrvHint: 'Herzfrequenzvariabilität, einzelne Messungen pro Tag gemittelt',
    rmssdHint: 'Nächtliche hochfrequente Variabilität, pro Tag gemittelt',
    respiratoryLabel: 'Atemfrequenz',
    respiratoryHint: 'Atemfrequenz während des Schlafs; das Band zeigt die an diesem Tag gemessene Spanne',
    restingLabel: 'Ruheherzfrequenz',
    restingHint: 'Ruheherzfrequenz, wie ZeppBridge sie pro Tag berechnet',
    unitScore: 'Pkt.',
    unitPerHour: '/Std.',
    unitBreathsPerMinute: 'Atemz./min',
  },
);
