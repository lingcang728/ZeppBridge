...
const messages = defineMessages(
  ...
  },
  {
    ...
    intro: 'VO₂max, Milchsäureschwelle, Trainingsbelastung und Herzfrequenzzonen. Alles aus synchronisierten Aufzeichnungen gelesen, keine Trainingsempfehlungen.',
    rangeAria: 'Zeitraum',
    desktopOnly: 'Bitte die Desktop-App verwenden. Diese Browser-Vorschau liest keine Kontodaten.',
    loadFailed: 'Trainingsstatus-Daten sind gerade nicht verfügbar',
    retry: 'Erneut versuchen',
    loadingAria: 'Trainingsstatus wird geladen',
    vo2Hint: 'Maximale Sauerstoffaufnahme, von der Uhr nach Outdoor-Läufen geschätzt',
    vo2Empty: 'Keine VO₂max-Aufzeichnungen in diesem Zeitraum; sie wird nur nach einem Outdoor-Lauf aktualisiert.',
    loadLabel: 'Trainingsbelastung',
    loadHint: 'Täglicher Trainingsbelastungswert',
    loadEmpty: 'Keine Aufzeichnungen zur Trainingsbelastung in diesem Zeitraum.',
    paiLabel: 'PAI',
    paiHint: 'Personal Activity Intelligence über die letzten 7 Tage',
    paiEmpty: 'Keine PAI-Aufzeichnungen in diesem Zeitraum.',
    thresholdLabel: 'Milchsäureschwelle',
    thresholdHint: 'Herzfrequenz und Tempo; wird nur nach einem intensiven Lauf aktualisiert',
    thresholdHr: 'Schwellen-Herzfrequenz',
    thresholdPace: 'Schwellentempo',
    thresholdChartAria: 'Herzfrequenz und Tempo an der Milchsäureschwelle',
    thresholdOnce: (date: string) => `Nur eine Schwellenmessung in diesem Zeitraum (${date}), daher lässt sich kein Trend zeichnen.`,
    thresholdEmpty: 'Keine Messungen der Milchsäureschwelle in diesem Zeitraum.',
    thresholdPaceTooltip: (value: string) => `Schwellentempo <b>${value}</b> /km`,
    thresholdHrTooltip: (value: number) => `Schwellen-Herzfrequenz <b>${value}</b> bpm`,
    balanceLabel: 'Trainingsbelastungsbalance',
    balanceHint: '7-Tage-Belastung im Verhältnis zum 28-Tage-Wochendurchschnitt, also das Verhältnis von akuter zu chronischer Belastung',
    balanceChartAria: '7-Tage- und 28-Tage-Trainingsbelastung mit dem Verhältnis akut/chronisch',
    balanceEmpty: 'Noch nicht genug Trainingsbelastungsdaten, um diese Kurve zu zeichnen.',
    balanceNote: 'Akut/chronisch = Summe der letzten 7 Tage ÷ (Summe der letzten 28 Tage ÷ 4). Deckt das 28-Tage-Fenster weniger als 21 Tage ab, wird kein Verhältnis angegeben und die Linie bricht dort ab. Das ist nicht berechnet, nicht null.',
    acute7d: '7-Tage-Belastung',
    chronicWeekly: '28-Tage-Wochendurchschnitt',
    acuteChronic: 'Akut/chronisch',
    ratioMissing: (days: number) => `— (im 28-Tage-Fenster liegen nur ${days} Tage mit Daten vor)`,
    acuteTooltip: (value: number, days: number) => `7-Tage-Belastung <b>${value}</b> (${days}/7 Tage mit Daten)`,
    chronicTooltip: (value: number) => `28-Tage-Wochendurchschnitt <b>${value}</b>`,
