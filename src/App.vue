...
const messages = defineMessages(
  ...
  },
  {
    ...
    identifyingDevices: 'Geräte werden identifiziert …',
    ...
    cancel: 'Abbrechen',
    compacting: (pending: number) =>
      `Gespeicherte Rohdaten werden komprimiert (noch ${pending}). Das erledigt sich von selbst, die Synchronisierung wartet währenddessen kurz.`,
    compacted: (saved: string) => `Gespeicherte Rohdaten komprimiert, rund ${saved} Speicherplatz freigegeben.`,
    trayHint: 'ZeppBridge läuft nach dem Schliessen des Fensters im Infobereich weiter, damit die automatische Synchronisierung aktiv bleibt.',
    browserPreview: 'Bitte die Desktop-App verwenden. Diese Browser-Vorschau liest keine Kontodaten.',
    routeNotFound: 'Diese Seite gibt es nicht, du bist zurück auf der Übersicht.',
  },
);
