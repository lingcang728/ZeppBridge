...
const messages = defineMessages(
  ...
  },
  {
    ...
    noNewDataWithLatest: (clock: string) => `Keine neuen Daten in der Cloud · letzte Herzfrequenz weiterhin ${clock}`,
    noNewData: 'Synchronisierung abgeschlossen. Keine neuen Daten in der Cloud',
    partialWithStreams: (streams: string) => `Einige Datenströme fehlgeschlagen: ${streams}`,
    partial: 'Synchronisierung abgeschlossen, aber einige Datenströme sind fehlgeschlagen',
    cancelled: 'Synchronisierung abgebrochen',
    deferred: 'Lokale abgeleitete Daten werden neu aufgebaut. Die Synchronisierung wird automatisch erneut versucht',
    failed: 'Synchronisierung fehlgeschlagen. Verbindung prüfen und erneut versuchen',
    ...
    statusUnavailable: 'Verbindungsstatus ist gerade nicht verfügbar',
    alreadySyncing: 'Es läuft bereits eine Synchronisierung. Später erneut versuchen',
    desktopOnly: 'Desktop-App verwenden',
    reauthNeeded: 'Deine Zepp-Sitzung ist abgelaufen. Erneut verbinden',
    verifyFirst: 'Verbindung zuerst überprüfen',
    connectFirst: 'Zuerst mit Zepp verbinden',
    syncingRecent: (days: number) => `Synchronisiere die letzten ${days} Tage…`,
    backfilling: (days: number) => `Lade die letzten ${days} Tage nach…`,
    syncDidNotFinish: 'Die Cloud-Synchronisierung wurde nicht abgeschlossen',
    cancelling: 'Synchronisierung wird abgebrochen…',
    cancelFailed: 'Synchronisierung konnte nicht abgebrochen werden',
    streamSeparator: ', ',
    syncingStream: (stream: string) => `Synchronisiere ${stream}`,
    backfillingStream: (stream: string, month: string) => `Lade ${stream} nach · ${month}`,
  },
);
