...
const messages = defineMessages(
  ...
  {
    unknownWithCode: (code: string) => `Unbekanntes Training (Code ${code})`,
    unknownWorkout: 'Unbekanntes Training',
    workout: 'Training',
    fallback: {
      run: 'Laufen (draussen)',
      running: 'Laufen',
      walking: 'Walking',
      walk: 'Gehen',
      ride: 'Radfahren (draussen)',
      cycling: 'Radfahren (draussen)',
      indoor_cycling: 'Indoor Cycling',
      swimming: 'Schwimmen',
      treadmill: 'Laufband',
      indoor_run: 'Laufen (drinnen)',
      trail: 'Trailrunning',
      hiking: 'Wandern',
      ...
      badminton: 'Badminton',
      activity: 'Aktivität',
      unknown: 'Unbekanntes Training',
    },
    providerZeppCloud: 'Zepp Cloud',
    scopeUserFused: 'Nutzerübergreifend zusammengeführt',
    scopeDevice: 'Einzelnes Gerät',
    scopeMixed: 'Mehrere Quellen',
    scopeUnknown: 'Bereich unbestätigt',
  },
);
